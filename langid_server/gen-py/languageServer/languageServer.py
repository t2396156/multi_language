...
class Client(Iface):
  ...
  def get_language(self, text):
    ...
    Parameters:
     - text
    """
    self.send_get_language(text)
    return self.recv_get_language()

  def send_get_language(self, text):
...
class Processor(Iface, TProcessor):
  ...
  def process_get_language(self, seqid, iprot, oprot):
    ...
    result = get_language_result()
    try:
      result.success = self._handler.get_language(args.text)
